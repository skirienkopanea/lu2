...
You can now access the game at http://localhost:3000/ in the browser. Open another browser window on your local machine to access the game as another player. From another machine in your local network the game should be accessible by using the host local ip address.
